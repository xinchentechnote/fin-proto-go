...
// ConfirmExtend010 represents the packet structure.
type ConfirmExtend010 struct {
...
// NewConfirmExtend010 creates a new instance of ConfirmExtend010.
func NewConfirmExtend010() *ConfirmExtend010 {
	return &ConfirmExtend010{}
}

// String returns a string representation of the packet.
func (p *ConfirmExtend010) String() string {
	return fmt.Sprintf("ConfirmExtend010{StopPx: %v, MinQty: %v, MaxPriceLevels: %v, TimeInForce: %v, CashMargin: %v}", p.StopPx, p.MinQty, p.MaxPriceLevels, p.TimeInForce, p.CashMargin)
}

// Encode encodes the packet into a byte slice.
func (p *ConfirmExtend010) Encode(buf *bytes.Buffer) error {
...
func (p *ConfirmExtend010) Decode(buf *bytes.Buffer) error {
