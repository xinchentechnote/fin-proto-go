...
// TradeCaptureReportAckExtend031 represents the packet structure.
type TradeCaptureReportAckExtend031 struct {
...
// NewTradeCaptureReportAckExtend031 creates a new instance of TradeCaptureReportAckExtend031.
func NewTradeCaptureReportAckExtend031() *TradeCaptureReportAckExtend031 {
	return &TradeCaptureReportAckExtend031{}
}

// String returns a string representation of the packet.
func (p *TradeCaptureReportAckExtend031) String() string {
	return fmt.Sprintf("TradeCaptureReportAckExtend031{MemberId: %v, TraderCode: %v, CounterPartyMemberId: %v, CounterPartyTraderCode: %v, SettlType: %v, SettlPeriod: %v, CashMargin: %v, Memo: %v}", p.MemberId, p.TraderCode, p.CounterPartyMemberId, p.CounterPartyTraderCode, p.SettlType, p.SettlPeriod, p.CashMargin, p.Memo)
}

// Encode encodes the packet into a byte slice.
func (p *TradeCaptureReportAckExtend031) Encode(buf *bytes.Buffer) error {
...
func (p *TradeCaptureReportAckExtend031) Decode(buf *bytes.Buffer) error {
