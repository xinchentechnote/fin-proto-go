...
func TestTradeCaptureConfirmCodec(t *testing.T) {

	applExtend := &msg.TradeCaptureConfirmExtend031{
		MemberId:               "xxxxxx",
		TraderCode:             "xxxxx",
	...
	original := &msg.TradeCaptureConfirm{
		PartitionNo:           4,
		ReportIndex:           8,
	...
	var decoded msg.TradeCaptureConfirm
