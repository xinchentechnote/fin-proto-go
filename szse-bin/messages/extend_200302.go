...
// Extend200302 represents the packet structure.
type Extend200302 struct {
...
// NewExtend200302 creates a new instance of Extend200302.
func NewExtend200302() *Extend200302 {
	return &Extend200302{}
}

// String returns a string representation of the packet.
func (p *Extend200302) String() string {
	return fmt.Sprintf("Extend200302{StopPx: %v, MinQty: %v, MaxPriceLevels: %v, TimeInForce: %v}", p.StopPx, p.MinQty, p.MaxPriceLevels, p.TimeInForce)
}

// Encode encodes the packet into a byte slice.
func (p *Extend200302) Encode(buf *bytes.Buffer) error {
...
func (p *Extend200302) Decode(buf *bytes.Buffer) error {
