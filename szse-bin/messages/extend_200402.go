...
// NewExtend200402 creates a new instance of Extend200402.
func NewExtend200402() *Extend200402 {
	return &Extend200402{}
}

// String returns a string representation of the packet.
func (p *Extend200402) String() string {
	return fmt.Sprintf("Extend200402{StopPx: %v, MinQty: %v, MaxPriceLevels: %v, TimeInForce: %v, PositionEffect: %v, CoveredOrUncovered: %v, ContractAccountCode: %v, SecondaryOrderId: %v}", p.StopPx, p.MinQty, p.MaxPriceLevels, p.TimeInForce, p.PositionEffect, p.CoveredOrUncovered, p.ContractAccountCode, p.SecondaryOrderId)
}

// Encode encodes the packet into a byte slice.
func (p *Extend200402) Encode(buf *bytes.Buffer) error {
...
func (p *Extend200402) Decode(buf *bytes.Buffer) error {
