...
// Extend204102 represents the packet structure.
type Extend204102 struct {
...
// NewExtend204102 creates a new instance of Extend204102.
func NewExtend204102() *Extend204102 {
	return &Extend204102{}
}

// String returns a string representation of the packet.
func (p *Extend204102) String() string {
	return fmt.Sprintf("Extend204102{StopPx: %v, MinQty: %v, MaxPriceLevels: %v, TimeInForce: %v, CashMargin: %v}", p.StopPx, p.MinQty, p.MaxPriceLevels, p.TimeInForce, p.CashMargin)
}
