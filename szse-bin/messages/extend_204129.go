...
// Extend204129 represents the packet structure.
type Extend204129 struct {
...
// NewExtend204129 creates a new instance of Extend204129.
func NewExtend204129() *Extend204129 {
	return &Extend204129{}
}

// String returns a string representation of the packet.
func (p *Extend204129) String() string {
	return fmt.Sprintf("Extend204129{MemberId: %v, InvestorType: %v, InvestorId: %v, InvestorName: %v, TraderCode: %v, SecondaryOrderId: %v, BidTransType: %v, BidExecInstType: %v, LowLimitPrice: %v, HighLimitPrice: %v, MinQty: %v, TradeDate: %v, SettlType: %v, SettlPeriod: %v, PreTradeAnonymity: %v, CashMargin: %v, Memo: %v}", p.MemberId, p.InvestorType, p.InvestorId, p.InvestorName, p.TraderCode, p.SecondaryOrderId, p.BidTransType, p.BidExecInstType, p.LowLimitPrice, p.HighLimitPrice, p.MinQty, p.TradeDate, p.SettlType, p.SettlPeriod, p.PreTradeAnonymity, p.CashMargin, p.Memo)
}
