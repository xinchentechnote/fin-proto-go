...
// Extend100301 represents the packet structure.
type Extend100301 struct {
...
// NewExtend100301 creates a new instance of Extend100301.
func NewExtend100301() *Extend100301 {
	return &Extend100301{}
}

// String returns a string representation of the packet.
func (p *Extend100301) String() string {
	return fmt.Sprintf("Extend100301{StopPx: %v, MinQty: %v, MaxPriceLevels: %v, TimeInForce: %v}", p.StopPx, p.MinQty, p.MaxPriceLevels, p.TimeInForce)
}

// Encode encodes the packet into a byte slice.
func (p *Extend100301) Encode(buf *bytes.Buffer) error {
...
func (p *Extend100301) Decode(buf *bytes.Buffer) error {
